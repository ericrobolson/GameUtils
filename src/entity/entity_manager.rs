use super::entity::{Entity, EntityId, Generation, MAX_ENTITIES};
...
impl EntityManager {
    ...
    pub fn create(&mut self) -> Entity {
        ...
        // Guard against an invalid index when creating a new entity. Basically, if the entity_id ends up being equal to or greater than the max entities, simply
        // reset the next id create a new entity.
        if entity_id >= Entity::MAX_ENTITIES() as u32 {
            self.next_id = 0;
            return self.create();
        }
